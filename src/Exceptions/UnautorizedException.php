...
class UnautorizedException extends \RuntimeException
{
    public function __construct()
    {
        ...
        parent::__construct('[401] Erro de Autenticação. confirme se sua autenticação pode realizar a ação desejada e se está usando o ambiente correto, lembre-se que as chaves de produção e de sandbox são distintas.',
            401);
    }
}